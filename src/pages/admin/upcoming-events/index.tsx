                  ...
                  events?.length ?
                    events.map((event, index) => (
                      <TableRow key={index} className="border-slate-800 hover:bg-transparent">
                        ...
                        <TableCell className="font-medium"><Link href={event.locationUrl}>{event.locationUrl}</Link></TableCell>
                        <TableCell className="font-medium"><Link href={event.registerUrl ?? "#"} className="text-white">{event.registerUrl ?? "-"}</Link></TableCell>
